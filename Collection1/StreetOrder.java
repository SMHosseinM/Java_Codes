...
public class StreetOrder
{
  public static void main(String[] args) 
  {
    ...
    try
    {
      ...
      List<DeliveryHouseDetails> arrayContainingLinesOfFile 
                                                   = new ArrayList<>();
      String currentLine;
      int lineNumber = 1;
      while((currentLine = input.readLine()) != null)
      {
        arrayContainingLinesOfFile.add(
                     new DeliveryHouseDetails(lineNumber, currentLine));
        lineNumber++;
      }//while
      
      Collections.sort(arrayContainingLinesOfFile);
      for(int i=0; i<arrayContainingLinesOfFile.size(); i++)
